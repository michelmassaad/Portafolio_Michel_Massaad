                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" align="center" class="rnb-col-1">
                                                    ...
                                                    <tr charset="utf-8">
                                                        <td charset="utf-8" class="content-spacing" style="font-family:"Tahoma",Geneva,sans-serif; color:#3c4858; text-align:center;">
                                                            ...
                                                            <span charset="utf-8" style="color:#3c4858;"><span style="font-size: 24px;"><b charset="utf-8">Recuperaci&oacute;n de contrase&ntilde;a</b></span></span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="10"></td>
                                                    ...
                                                    <tbody><tr>
                                                        <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                            ...
                                                            <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                ...
                                                                <tbody><tr>
                 <td class="content-spacing" style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858; line-height: 21px;"><div><span style="color:#000000;"><span style="font-size:15px;">Hola </span></span><span style="font-weight:bold;color:black;">'.ucwords($row["nombre"])." ".ucwords ($row["apellido"]).'</span><span style="color:#000000;"><span style="font-size:15px;">, le hemos enviado un email de recuperacion de contraseña. Si usted realizo esta solicitud, entrar al siguiente link...</span></span></div>
</td>
                                                                </tr>
                                                                </tbody></table>
...
<a style="text-decoration:none; color:#000000; font-weight:normal;" target="_blank" 
    ...
    href="http://localhost/RecetaRapi/olvido%20de%20contrase%c3%b1a/recuperar%20clave.php?nombre='.ucwords($row['nombre']).'&apellido='.ucwords($row['apellido']).'&id='.$row['id'].'&token='.$token.'"><strong style="padding:15px;border-radius:5%;"> Recuperar </strong></a>
                                                    ...
                                                    <tbody><tr>
                                                        <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                            ...
                                                            <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                ...
                                                                <tbody><tr>
                                                                    <td class="content-spacing" style="font-size:14px; font-family:"Tahoma",Geneva,sans-serif, sans-serif; color:#3c4858; line-height: 21px;"><div style="text-align: center;"><span style="font-size:15px;"><span style="color:#000000;"><strong>En caso de no haber realizado esta petición hacer caso omiso.</strong></span></span></div>
</td>
                                                                </tr>
                                                                </tbody></table>
